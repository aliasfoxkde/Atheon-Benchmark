...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Results Page Smoke Tests >> should load the results page
- Location: __tests__/e2e/critical-paths.spec.ts:83:9
