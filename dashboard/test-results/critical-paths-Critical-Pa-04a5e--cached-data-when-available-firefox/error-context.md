...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> API Integration Smoke Tests >> should use cached data when available
- Location: __tests__/e2e/critical-paths.spec.ts:203:9
