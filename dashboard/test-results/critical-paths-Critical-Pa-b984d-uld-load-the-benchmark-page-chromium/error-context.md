...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Benchmark Page Smoke Tests >> should load the benchmark page
- Location: __tests__/e2e/critical-paths.spec.ts:140:9
