...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Responsive Design Smoke Tests >> should work on tablet viewport
- Location: __tests__/e2e/critical-paths.spec.ts:235:9
