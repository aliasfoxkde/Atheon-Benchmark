...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Error Handling Smoke Tests >> should handle invalid API data gracefully
- Location: __tests__/e2e/critical-paths.spec.ts:297:9
