...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Application Startup >> should have working navigation
- Location: __tests__/e2e/critical-paths.spec.ts:25:9
