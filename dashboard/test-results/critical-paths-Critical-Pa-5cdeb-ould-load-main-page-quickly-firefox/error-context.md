...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Performance Smoke Tests >> should load main page quickly
- Location: __tests__/e2e/critical-paths.spec.ts:259:9
