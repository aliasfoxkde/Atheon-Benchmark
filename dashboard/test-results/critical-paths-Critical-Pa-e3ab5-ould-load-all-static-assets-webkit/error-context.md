...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Application Startup >> should load all static assets
- Location: __tests__/e2e/critical-paths.spec.ts:42:9
