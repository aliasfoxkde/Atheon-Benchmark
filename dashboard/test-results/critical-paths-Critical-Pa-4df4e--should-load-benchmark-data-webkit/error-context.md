...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Results Page Smoke Tests >> should load benchmark data
- Location: __tests__/e2e/critical-paths.spec.ts:97:9
