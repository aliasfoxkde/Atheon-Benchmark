...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Benchmark Page Smoke Tests >> should have benchmark form or content
- Location: __tests__/e2e/critical-paths.spec.ts:154:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/benchmark
Call log:
  - navigating to "http://localhost:3000/benchmark", waiting until "load"
