...
- Name: critical-paths.spec.ts >> Critical Path Smoke Tests >> Performance Smoke Tests >> should load results page quickly
- Location: __tests__/e2e/critical-paths.spec.ts:269:9
